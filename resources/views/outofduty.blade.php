...
<body>
    <div class="flex flex-col justify-center m-24 mt-10 gap-5">
        ...
        <h1 class="text-2xl text-center font-bold text-gray-800">Out of Duty Permit</h1>
        <div class="card border mt-5">
            <div class="card-body items-center">
                <div class="flex flex-row items-center w-full gap-5">
                    <div class="font-semibold text-lg basis-1/4">Name</div>
                    <div class="font-semibold text-lg">:</div>
                    <input class="input input-bordered input-sm font-semibold text-lg w-full" value="{{ $data->name }}" />
                </div>
                <div class="flex flex-row items-center w-full gap-5">
                    <div class="font-semibold text-lg basis-1/4">Date</div>
                    <div class="font-semibold text-lg">:</div>
                    <input class="input input-bordered input-sm font-semibold text-lg w-full" value="{{ $data->date }}"/>
                </div>
                <div class="flex flex-row items-center w-full gap-5">
                    <div class="font-semibold text-lg basis-1/4">Time</div>
                    <div class="font-semibold text-lg">:</div>
                    <div class="grid grid-flow-col gap-5 w-full justify-start">
                        <div class="grid grid-flow-col items-center text-lg font-semibold gap-3">
                            <p>From</p>
                            <input class="input input-bordered input-sm font-semibold text-lg w-20" value="{{ $data->start_time }}"/>
                        </div>
                        <div class="grid grid-flow-col items-center text-lg font-semibold gap-3">
                            <p>To</p>
                            <input class="input input-bordered input-sm font-semibold text-lg w-20" value="{{ $data->end_time }}"/>
                        </div>
                    </div>
                </div>
                <div class="flex flex-row items-center w-full gap-5">
                    <div class="font-semibold text-lg basis-1/4">Destination</div>
                    <div class="font-semibold text-lg">:</div>
                    <input class="input input-bordered input-sm font-semibold text-lg w-full" value="{{ $data->destination }}"/>
                </div>
                <div class="flex flex-row w-full gap-5">
                    <div class="font-semibold text-lg basis-1/4">Purpose</div>
                    <div class="font-semibold text-lg">:</div>
                    <textarea class="textarea textarea-bordered font-semibold text-lg w-full" maxL>{{ $data->purpose }}</textarea>
                </div>
            </div>
        </div>
        ...
        <table class="border-collapse border table-fixed w-full mt-5">
            ...
            <tbody>
                ...
                <tr>
                    <td class="border border-t-0 text-center">{{ $data->name }}</td>
                    @foreach($users as $user)
                        <td class="border border-t-0 text-center">{{ $user->name}}</td>
                    @endforeach
                </tr>
            </tbody>
        </table>
